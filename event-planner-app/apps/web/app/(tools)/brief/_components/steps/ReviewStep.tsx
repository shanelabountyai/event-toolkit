              ...
              return (
                <li key={`${issue.path}-${i}`} className="flex flex-wrap items-center gap-2">
                  ...
                  {section ? (
                    <button
                      type="button"
                      className="rounded-full border border-red-300 bg-white px-2 py-0.5 text-xs font-medium text-red-800 hover:bg-red-100"
            ...
            <Card key={section.section}>
              <CardHeader className="border-b-0 py-3">
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-slate-500">{section.summary(brief)}</p>
                </div>
