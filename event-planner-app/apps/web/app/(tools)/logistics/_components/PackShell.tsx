      ...
      <header className="no-print space-y-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-xs text-slate-500">{SAVE_LABELS[saveState]}</span>
        ...
        <nav className="flex flex-wrap gap-1 border-b border-slate-200" aria-label="Logistics pack sections">
          {TABS.map((tab) => {
...
export function PackNotFound() {
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
      <h1 className="text-lg font-semibold text-slate-900">That logistics pack no longer exists</h1>
